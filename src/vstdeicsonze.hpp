...
#ifndef __DEICSONZE_VSTDEICSONZE_HPP
#define __DEICSONZE_VSTDEICSONZE_HPP
...
class VSTDeicsonze : public AudioEffectX
{
public:
	Deicsonze deicsonze;
	...
	VSTDeicsonze(audioMasterCallback audioMaster);
	~VSTDeicsonze();
